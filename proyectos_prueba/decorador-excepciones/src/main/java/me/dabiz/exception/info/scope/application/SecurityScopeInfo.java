...
public final class SecurityScopeInfo extends ApplicationScopeInfo<CategoryInfo> {

    public SecurityScopeInfo(Micro micro, CategoryInfo categoryInfo){
        super(micro, Scope.SECURITY, categoryInfo);
    }
}
